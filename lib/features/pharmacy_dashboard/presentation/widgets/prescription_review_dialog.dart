...
class _PrescriptionReviewDialogState
    extends State<PrescriptionReviewDialog> {
              ...
              children: [
                        ...
                        return const Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 8),
                              Text(
                                'Imagem da receita médica indisponível',
                                style: TextStyle(
                                  color: Colors.grey,
                                ),
                                textAlign:
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText:
                        'Observações do Farmacêutico (Opcional)',
                    hintText:
                        'Ex: Validade confirmada. Dosagem correta.',
                    prefixIcon: Icon(
